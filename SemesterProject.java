        ...
        //Prompts to play y/n
            ...
            //yes - start game
                if (r1.equalsIgnoreCase("y")){
                    ...
                    System.out.println(" ");
                //Create an object of the Game class (pass Scanner to avoid conflicts)
            ...
            //no - quit program/Loop
                        ...
                        System.out.println("Input Detected.");
                        System.out.println("Thanks for considering! Goodbye.");
                        System.out.println(" ");
                        }
...
class Game{        
    ...
    //Declarations
        ...
        //Constructor to receive Scanner
        ...
        //Game Active
            ...
            //Wallet Code (How it works and flow of money)
                ...
                //Ask User, 'Will next card be between these two?' y/n
                    ...
                    //Validate y/n input
                    while (!userGuess.equalsIgnoreCase("y") && !userGuess.equalsIgnoreCase("n")) {
                ...
                //Boolean expression to compare card c to the min & max
                    ...
                    //Check for boundary card match FIRST (this takes priority)
                        if (isEquals) {
                            System.out.println(" ");
                    ...
                    //yes + true :)
                            ...
                            //WIN ~ add double the bet to wallet 
                                System.out.println(" ");
